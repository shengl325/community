...
import org.murasame.community.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testSearchByTemplate() {
        ...
        Page<DiscussPost> page = elasticsearchTemplate.queryForPage(searchQuery,
                DiscussPost.class, new SearchResultMapper() {
                    ...
                    public <T> AggregatedPage<T> mapResults(SearchResponse response, Class<T> clazz, Pageable pageable) {
                        ...
                        for (SearchHit hit : hits) {
                            ...
                            post.setId(Integer.parseInt(userId));
                            ...
                            String commentCount =
                                    hit.getSourceAsMap().get("commentCount").toString();
