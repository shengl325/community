...
import org.murasame.community.service.MessageService;
...
public class MessageController {
    ...
    public String getLetterList(Model model, Page page) {
        ...
        if (conversationList != null) {
            for (Message message : conversationList) {
                ...
                int targetId = user.getId() == message.getFromId() ? message.getToId() :
                        message.getFromId();
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId,
        ...
        //私信列表
        List<Message> letterList = messageService.findLetters(conversationId, page.getOffset(),
                page.getLimit());
